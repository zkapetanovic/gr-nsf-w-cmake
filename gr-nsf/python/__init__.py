...
'''
This is the GNU Radio NSF module. Place your Python package
description here (python/__init__.py).
'''

# import swig generated symbols into the nsf namespace
try:
	# this might fail if the module is python-only
	from nsf_swig import *
except ImportError:
	pass

# import any pure python here
from ra_vsum import ra_vsum
